...
var InverseInorder = function(p_data_processor, p_root){
    Traversal.call(this, p_data_processor, p_root);
}

InverseInorder.prototype = Object.create(Traversal.prototype);
InverseInorder.traverse = function(){
    Traversal.prototype.traverse.call(this);
}
InverseInorder.prototype.traverseH = function(p_runner_node){
    if(null == p_runner_node)
        return;
...
exports.InverseInorder = InverseInorder;
