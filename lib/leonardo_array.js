...
LeonardoArray.prototype = (function(){
    var traverse = function(p_index, p_processor){
        ...
        while(null != current_node){
            ...
            if(null != current_node.m_left_child && current_node.m_left_child.m_data.m_index > p_index)
    ...
    var setupH = function(p_n){
        ...
        m_memory = new leo_tree.LeonardoTree(p_n);
        m_traversal = new tree_trav.InversePreorder(new nod_proc.ArrayNodeProcessor(), m_memory.getRoot());
...
exports.LeonardoArray = LeonardoArray;
